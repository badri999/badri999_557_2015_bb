...
void GLSphere::initShader(void)
{
    ...
    _material._specular_material = glm::vec3(1.0, 0.0, 0.0);
...
void GLSphere::initShader1(void)
{
	...
	// define the position of the light and send the light position to your shader program
	_light_source0._lightPos = glm::vec4(50.0, 0.0, 100.0, 1.0);
	_light_source0._ambient_intensity = 0.5;
	_light_source0._specular_intensity = 1.0;
...
void GLSphere::initShader3(void)
{
	...
	// define the position of the light and send the light position to your shader program
	_light_source1._lightPos = glm::vec4(65.0, 55, -5, 1.0);
	_light_source1._ambient_intensity = 0.0;
	_light_source1._specular_intensity = 1.0;
	_light_source1._diffuse_intensity = 100.0;


	_light_source1._cone_angle = 45; // in degree
	_light_source1._cone_direction = glm::vec3(-2.0, -30.0, 20.0); 
...
void GLSphere::initShader4(void)
{
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	// Material
	_material._diffuse_material = glm::vec3(0.933, 0.866, 0.509);
	_material._ambient_material = glm::vec3(0.933, 0.866, 0.509);
	_material._specular_material = glm::vec3(0.933, 0.866, 0.509);
	_material._shininess = 12.0;
