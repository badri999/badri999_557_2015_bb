...
void GLPlane3D::init(void)
{
    ...
    initVBO();
	//rotation_badri
	glm::mat4 _rotatedMatrix = glm::rotate(glm::mat4(1.0), -1.57f, glm::vec3(1.0f, 0.0f, 0.0f));
	//glm::mat4 _rotatedMatrix1 = glm::rotate(glm::mat4(1.0), 1.57f, glm::vec3(0.0f, 0.0f, 1.0f));
	//_modelMatrix
	_modelMatrix = _modelMatrix*_rotatedMatrix;
		//
...
void GLPlane3D::draw(void)
{
	...
	//new_line
	//_modelMatrix = glm::rotate(glm::mat4(0.0), 90.0f, glm::vec3(1.0f, 0.0f, 0.0f));
